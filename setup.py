...
setup(
    ...
    long_description='''Mnemosyne is a web service that saves image links,
                        analyze them, and create tasks in a PyBossa server''',
    license='AGPLv3',
    url='https://github.com/PyBossa/mnemosyne',
    download_url='https://github.com/PyBossa/mnemosyne',
